 ...
 */
#ifndef __UVISOR_LIB_TEST_BOX0_H__
#define __UVISOR_LIB_TEST_BOX0_H__

/* box 0 configuration macro */
#define UVISOR_LIB_TEST_SETUP_BOX0() \
    /* create ACLs for main box */ \
    UVISOR_LIB_TEST_DEFAULT_ACL_BOX0(g_acl_box0); \
    /* enable uvisor */ \
    UVISOR_SET_MODE_ACL(UVISOR_ENABLED, g_acl_box0);

/* target specifc ACLs for box 0 */
#if   defined(TARGET_LIKE_FRDM_K64F)

#define UVISOR_LIB_TEST_DEFAULT_ACL_BOX0(acl_list_name) \
...
#endif/*__UVISOR_LIB_TEST_BOX0_H__*/
